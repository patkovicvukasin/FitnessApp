...
export default function CreateEmployeePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Greška pri kreiranju zaposlenog');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
      <div style={{
        ...
        <h1 style={{ margin: '0 0 10px 0' }}>Novi zaposleni</h1>
        <p style={{ margin: 0, color: '#666' }}>Dodajte novog zaposlenog</p>
      </div>
